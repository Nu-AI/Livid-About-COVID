...
cite_string = r'@inproceedings{souresSIRNetIJCAI2020,title     = {SIRNet: Understanding Social Distancing Measures with Hybrid Neural Network Model for COVID-19 Infectious Spread},authors   = {Soures, Nicholas and Chambers, David and Carmichael, Zachariah and Daram, Anurag and Clark, Kal and Shah, Pankil and Shah, Dimpy and Potter, Lloyd and Kudithipudi, Dhireesha},booktitle = {Proceedings of the International Joint Conference on Artificial Intelligence, {IJCAI}},series    = {Disease Computational Modeling Workshop},year      = {2020}}'
