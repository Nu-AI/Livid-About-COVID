...
import geojson
from os import path
from get_model_predictions import get_model_preds
...
def plot_data(selected_date, selected_percent, clickData):
    ...
    actives, totals = get_model_preds(mob_df.reset_index())
    ...
    fig3 = cont_error_bar(fig3, totalpred_df['date'], total_predicted_cases_0_3[int(selected_percent)],
                         totalpred_df[int(selected_percent)],total_predicted_cases_0_05[int(selected_percent)], selected_percent)
