...
mobility, cases, day0, population, prev_cases, df = fit_bexar_mask.load_data(param)
# model = fit_bexar_mask.model_and_fit('Bexar_weights.pt', mobility, cases, population, prev_cases, param,
#                   summary_writer=None)
actives, totals = fit_bexar_mask.pipeline(param)
